...
A compatibility wrapper for errgenkratos, providing the classic protoc-gen-go-errors command while leveraging the latest implementation.
...
This project provides backward compatibility for existing protoc-gen-go-errors users while delegating all functionality to the new [errgenkratos](https://github.com/orzkratos/errgenkratos) project. 

**For new projects, we recommend using [errgenkratos](https://github.com/orzkratos/errgenkratos) directly for the latest features and improvements.**
...
```go
// Generated by protoc-gen-go-errors
...
For new features and active development, consider migrating to [errgenkratos](https://github.com/orzkratos/errgenkratos):

```bash
# Install the new plugin
go install github.com/orzkratos/errgenkratos/cmd/protoc-gen-orzkratos-errors@latest

# Update your protoc command
