...
An enhanced protoc plugin for Kratos error handling code generation, reducing boilerplate code with custom field extensions.
...
### Option 1: Compatible Version (Drop-in Replacement)
```bash
go install github.com/orzkratos/errgen/cmd/protoc-gen-go-errors@latest
```

### Option 2: Branded Version (orzkratos Style)
```bash
...
You have two ways to configure metadata fields:

**Option 1: In your business code (recommended)**
