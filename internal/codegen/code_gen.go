...
import (
	...
	"github.com/orzkratos/errgen/internal/codegen/errors"
...
const (
	...
	errgenPackage = protogen.GoImportPath("github.com/orzkratos/errgen")
)
...
func GenerateFile(gen *protogen.Plugin, file *protogen.File, config Config) *protogen.GeneratedFile {
	...
	g.QualifiedGoIdent(errgenPackage.Ident(""))
